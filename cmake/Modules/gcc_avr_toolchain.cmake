...
function (setup_gcc_avr_defaults)
  ...
  if (NOT AVR_SIZE_ARGS)
    if (APPLE)
      set(AVR_SIZE_ARGS -B PARENT_SCOPE)
    else (APPLE)
      set(AVR_SIZE_ARGS -C;--mcu=${AVR_MCU} PARENT_SCOPE)
    endif (APPLE)
  endif ()

  if (NOT AVR_UPLOADTOOL_BASE_OPTIONS)
    set(AVR_UPLOADTOOL_BASE_OPTIONS -D -v -p ${AVR_MCU} -c ${AVR_PROGRAMMER})
    set(AVR_UPLOADTOOL_BASE_OPTIONS ${AVR_UPLOADTOOL_BASE_OPTIONS} PARENT_SCOPE)
  endif ()
  ...
  ##########################################################################
  if (WITH_MCU)
    set(MCU_TYPE_FOR_FILENAME "-${AVR_MCU}" PARENT_SCOPE)
  else ()
    set(MCU_TYPE_FOR_FILENAME "" PARENT_SCOPE)
  endif ()
